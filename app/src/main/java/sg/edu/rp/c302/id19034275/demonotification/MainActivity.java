package sg.edu.rp.c302.id19034275.demonotification;
            ...
            public void onClick(View v) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                    ...
                    NotificationChannel channel2 = new
                            NotificationChannel("hi", "Wewiming Channel",
                            NotificationManager.IMPORTANCE_HIGH);

                    channel.setDescription("This is for default notification");
                    notificationManager.createNotificationChannel(channel);
                    channel2.setDescription("This is for default weiming");
                ...
                NotificationCompat.Builder builder = new
                        NotificationCompat.Builder(MainActivity.this, "hi");
